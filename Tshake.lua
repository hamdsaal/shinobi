...
send(chat,msg.id_,"🔰┇تم رفع الملف بنجاح وتفعيل المجموعات\n📬┇ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنز} بنجاح")   
end
...
if text == "مسح الادمنز" and Owner(msg) then
...
if text == ("الادمنز") and Owner(msg) then
...
local taha = "👤┇ عدد الادمنز : "..data.administrator_count_..
...
if text ==("رفع الادمنز") and Owner(msg) then
...
🌐┇TshAkE TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/IKSAI)

📋┇ [TshAkE Dev](https://t.me/IKSAI)

📁┇ [Source  Files](https://t.me/IKSAI)

🌐┇ [TshAkE iNDT](https://t.me/Alm4kr)
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS TshAkE](https://t.me/IKSAI)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
{'تنظيف القروبات ℹ','تنظيف المشتركين ♠'},
